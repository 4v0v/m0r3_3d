...
local function closest_point_on_line_segment(
...
local function triangle_ray(
    ...
    local e11,e12,e13 = Vectors:subtract(tri_1_x,tri_1_y,tri_1_z, tri_0_x,tri_0_y,tri_0_z)
    local e21,e22,e23 = Vectors:subtract(tri_2_x,tri_2_y,tri_2_z, tri_0_x,tri_0_y,tri_0_z)
    ...
    local s1,s2,s3 = Vectors:subtract(src_x,src_y,src_z, tri_0_x,tri_0_y,tri_0_z)
...
local function triangle_sphere(
        tri_0_x, tri_0_y, tri_0_z,
        tri_1_x, tri_1_y, tri_1_z,
        tri_2_x, tri_2_y, tri_2_z,
    ...
    local dist = Vectors:fast_dot_product(src_x - tri_0_x, src_y - tri_0_y, src_z - tri_0_z, n_x, n_y, n_z)
    ...
    local c0_x, c0_y, c0_z = Vectors:fast_cross_product(itx_x - tri_0_x, itx_y - tri_0_y, itx_z - tri_0_z, tri_1_x - tri_0_x, tri_1_y - tri_0_y, tri_1_z - tri_0_z)
    local c1_x, c1_y, c1_z = Vectors:fast_cross_product(itx_x - tri_1_x, itx_y - tri_1_y, itx_z - tri_1_z, tri_2_x - tri_1_x, tri_2_y - tri_1_y, tri_2_z - tri_1_z)
    local c2_x, c2_y, c2_z = Vectors:fast_cross_product(itx_x - tri_2_x, itx_y - tri_2_y, itx_z - tri_2_z, tri_0_x - tri_2_x, tri_0_y - tri_2_y, tri_0_z - tri_2_z)
    ...
    local line1_x, line1_y, line1_z = closest_point_on_line_segment(tri_0_x, tri_0_y, tri_0_z, tri_1_x, tri_1_y, tri_1_z, src_x, src_y, src_z)
    ...
    local line2_x, line2_y, line2_z = closest_point_on_line_segment(tri_1_x, tri_1_y, tri_1_z, tri_2_x, tri_2_y, tri_2_z, src_x, src_y, src_z)
    ...
    local line3_x, line3_y, line3_z = closest_point_on_line_segment(tri_2_x, tri_2_y, tri_2_z, tri_0_x, tri_0_y, tri_0_z, src_x, src_y, src_z)
...
local function triangle_capsule(
    ...
    if dotOfNormals > 0 then
        ...
        local t = Vectors:fast_dot_product(n_x, n_y, n_z, (tri_0_x - base_x) / dotOfNormals, (tri_0_y - base_y) / dotOfNormals, (tri_0_z - base_z) / dotOfNormals)
...
function Collisions:create_collision_zone(zoneSize)
...
function Collisions:generate_aabb(vertices)
    local aabb = {
        min = { math.huge, math.huge, math.huge },
        max = { -1*math.huge, -1*math.huge, -1*math.huge}
    }
...
function Collisions:collide_with_ray(src_1, src_2, src_3, dir_1, dir_2, dir_3)
    local dir_1, dir_2, dir_3 = Vectors:fast_normalize(dir_1, dir_2, dir_3)

	local t1 = (self.aabb.min[1] * self.sx + self.x - src_1) / dir_1
	local t2 = (self.aabb.max[1] * self.sx + self.x - src_1) / dir_1
	local t3 = (self.aabb.min[2] * self.sy + self.y - src_2) / dir_2
	local t4 = (self.aabb.max[2] * self.sy + self.y - src_2) / dir_2
	local t5 = (self.aabb.min[3] * self.sz + self.z - src_3) / dir_3
	local t6 = (self.aabb.max[3] * self.sz + self.z - src_3) / dir_3
